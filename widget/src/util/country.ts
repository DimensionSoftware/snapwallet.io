...
export const countries: { [iso2: string]: ICountry } = {
  ...
  BM: { name: 'Bermuda', dial_code: '+1', code: 'BM' },
  ...
  KY: { name: 'Cayman Islands', dial_code: '+1', code: 'KY' },
  ...
  DM: { name: 'Dominica', dial_code: '+1', code: 'DM' },
  DO: { name: 'Dominican Republic', dial_code: '+1', code: 'DO' },
  ...
  GD: { name: 'Grenada', dial_code: '+1', code: 'GD' },
  GP: { name: 'Guadeloupe', dial_code: '+590', code: 'GP' },
  GU: { name: 'Guam', dial_code: '+1', code: 'GU' },
  ...
  JM: { name: 'Jamaica', dial_code: '+1', code: 'JM' },
  ...
  MP: { name: 'Northern Mariana Islands', dial_code: '+1', code: 'MP' },
  ...
  PR: { name: 'Puerto Rico', dial_code: '+1', code: 'PR' },
  ...
  KN: { name: 'Saint Kitts and Nevis', dial_code: '+1', code: 'KN' },
  LC: { name: 'Saint Lucia', dial_code: '+1', code: 'LC' },
  ...
  TC: { name: 'Turks and Caicos Islands', dial_code: '+1', code: 'TC' },
  ...
  VG: { name: 'Virgin Islands, British', dial_code: '+1', code: 'VG' },
  VI: { name: 'Virgin Islands, U.S.', dial_code: '+1', code: 'VI' },
...
// Get whitelist from https://docs.sendwyre.com/docs/country-list
export const WYRE_SUPPORTED_COUNTRIES = [
  'DZ',
  'AR',
  'AU',
  'AT',
