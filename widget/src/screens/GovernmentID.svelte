  ...
  <ModalBody>
    ...
    <label label="US Government ID Kind">
      ...
      <select bind:value={usIDKind}>
        <option value="GI_US_DRIVING_LICENSE"
          >US Drivers' license (front/back)</option
        >
        <option value="GI_US_PASSPORT_CARD"
          >US Passport Card (front/back)</option
        >
        <option value="GI_US_GOVERNMENT_ID"
          >US Government ID (front/back)</option
        >
