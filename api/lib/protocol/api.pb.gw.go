...
var (
	pattern_API_UserData_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"user-data"}, ""))

	pattern_API_PricingData_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"pricing-data"}, ""))
)
