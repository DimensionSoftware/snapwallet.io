...
func (m *MockDb) SavePlaidItem(ctx context.Context, userID user.ID, itemID item.ID, accessToken string, accountIDs []string) (*item.Item, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SavePlaidItem", ctx, userID, itemID, accessToken, accountIDs)
...
func (mr *MockDbMockRecorder) SavePlaidItem(ctx, userID, itemID, accessToken, accountIDs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SavePlaidItem", reflect.TypeOf((*MockDb)(nil).SavePlaidItem), ctx, userID, itemID, accessToken, accountIDs)
}
