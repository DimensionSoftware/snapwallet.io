...
export class ObservableFluxApi {
     ...
     * @param body 
     */
    public fluxUploadFile(body: ApiHttpBody, options?: Configuration): Observable<ApiHttpBody> {
    	const requestContextPromise = this.requestFactory.fluxUploadFile(body, options);
